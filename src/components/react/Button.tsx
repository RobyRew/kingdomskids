  ...
  ],
  {
    variants: {
      variant: {
        ...
        tertiary: ['font-medium', 'text-black hover:text-orange active:text-orange'],
        quaternary: [
          'justify-start',
          'font-medium',
          'text-sm text-black',
        ...
        burger: ['text-black hover:text-orange active:text-orange'],
        logo: [
          'font-bold',
      ...
      size: {
        ...
        tertiary: ['px-5 py-2.5'],
        quaternary: ['px-2.5 py-2.5'],
        burger: ['p-2.5'],
        logo: ['px-5 py-1.5'],
      },
    },
